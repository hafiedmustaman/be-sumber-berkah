...
class OrderController extends Controller
{
     ...
     * @return void
     */
    public function index() // fungsi eloquent untuk mendapatkan data invoice berdasarkan customer yang sedang login dan datanya diurutkan berdasarkan yang paling terbaru.
    {
